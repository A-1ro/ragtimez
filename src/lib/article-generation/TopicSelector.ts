  ...
  async select(input: {
    ...
    const raw = await this.llmClient.generateText({
      ...
      system:
        ...
        '- "topic": English description of the chosen topic (1 sentence). MUST be about ONE specific product, service, or announcement — never combine multiple companies or unrelated announcements with "and" or commas. BAD: "iOS 27 AI features and OpenAI spend controls". GOOD: "iOS 27 Foundation Models framework for third-party app integration".\n' +
