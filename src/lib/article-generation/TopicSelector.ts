  ...
  async select(input: {
    ...
    const raw = await this.llmClient.generateText({
      ...
      system:
        ...
        '- "topic": The SPECIFIC product, feature, or announcement being covered — must name the exact subject (e.g., \'Gmail Live voice email search\', \'Google Search AI Overviews + AI Mode unification\', \'Azure AI Foundry SDK v2.0 release\'). NOT a broad trend category (e.g., \'AI search trends\', \'new AI developments\', \'latest LLM updates\'). One sentence.\n' +
