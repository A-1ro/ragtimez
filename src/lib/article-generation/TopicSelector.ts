  ...
  async select(input: {
    ...
    const raw = await this.llmClient.generateText({
      ...
      system:
        ...
        '- "topic": English description of the chosen topic (1 sentence). Must name exactly ONE product/feature/announcement — if your sentence contains " and " (or would need "と") to join two different product or feature names, you have picked two topics; keep only the stronger one.\n' +
