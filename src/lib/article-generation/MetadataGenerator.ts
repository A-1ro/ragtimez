    ...
    const baseSystem =
      input.lang === "en"
        ...
        : "You are a Japanese senior engineer writing a technical blog. " +
          "Read the provided article body and generate metadata that accurately reflects the article's actual content. Output ONLY valid JSON.\n" +
          "The JSON must have exactly these three keys:\n" +
          '- "title": a specific, descriptive Japanese headline (20-50 chars) that summarizes what this article is actually about. Avoid vague words like "最新動向" or "まとめ". The title MUST name the specific technology or product — for example "DiScoFormerによる密度推定とスコアマッチングの統合" is good; "トランスフォーマー技術の最新動向" is REJECTED.\n' +
