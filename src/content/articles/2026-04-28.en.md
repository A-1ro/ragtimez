---
title: "Nova 2 Sonic Migration"
date: 2026-04-28
summary: "This article explains how to migrate from text agents to voice assistants using Amazon Nova 2 Sonic. Voice agent design requires breaking down information into easily digestible chunks and incorporating confirmation loops. The Strands Agents SDK's BidiAgent enables easy construction of agents with real-time voice interaction."
sources:
...
:::admin-note[A-1ro]
The article content is largely accurate, but the `pip install` command in the summary is incomplete.
