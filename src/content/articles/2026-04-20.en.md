...
Currently, only account-level tiering for Zone Redundant Storage (ZRS, GZRS, RA-GZRS) is supported, and conversion to non-zone redundant (LRS, GRS) is not available. (Source: https://learn.microsoft.com/en-us/azure/storage/blobs/access-tiers-smart)
...
The performance characteristics and SLA for data access conform to the specifications of the underlying capacity tier. (Source: https://learn.microsoft.com/en-us/azure/storage/blobs/access-tiers-overview)
