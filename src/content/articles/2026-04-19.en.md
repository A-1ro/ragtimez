...
Accessed objects are automatically moved back to the Hot tier, and the tiering cycle resumes. This automatic migration enables significant cost reduction without the need for manual lifecycle management rules. (Source: [azure.microsoft.com](https://azure.microsoft.com/en-us/blog/optimize-object-storage-costs-automatically-with-smart-tier-now-generally-available/))
...
Enabling Smart Tier on an existing storage account will migrate all blobs without an explicitly set access tier to Smart Tier. (Source: [learn.microsoft.com](https://learn.microsoft.com/en-us/azure/storage/blobs/access-tiers-smart))
...
Objects with an explicitly set tier cannot be reverted to Smart Tier. (Source: [learn.microsoft.com](https://learn.microsoft.com/en-us/azure/storage/common/storage-plan-manage-costs))
