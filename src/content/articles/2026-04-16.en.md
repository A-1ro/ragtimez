...
With Smart Tier, such complex settings are no longer necessary. Only account-level settings are required, and all blobs are automatically managed. (Source: [learn.microsoft.com](https://learn.microsoft.com/en-us/azure/storage/blobs/access-tiers-smart))
