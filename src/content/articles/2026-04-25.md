...
:::admin-note[A-1ro]
この記事は、タイトルは「Azure OpenAI Serviceで使用できるようになったGPT-5.5の具体的な紹介」のように見えますが、記事の実態としては「最近のAzure OpenAI Serviceの動向」であることに注意が必要です。

また「推論モデルの拡充とFunction Calling対応」の章では「GPT-5シリーズにo3-mini、o1、o1-miniがある」ような記述になってしまっていますが、これは誤りです。
o3-mini、o1、o1-mini は GPT-5 シリーズではなく、独立した o-series(reasoning models)に属するモデルです。Microsoft Foundry の公式ドキュメントでも両者は別カテゴリとして扱われています。
:::
