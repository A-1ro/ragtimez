 ...
 * Usage
 * -----
 *   npx tsx scripts/setup-ai-search.ts
 *
 * What it does
 * ------------
...
import { CRAWL_TARGETS } from "../src/constants/crawlTargets.js";
...
const BASE_URL = `https://api.cloudflare.com/client/v4/accounts/${ACCOUNT_ID}/ai-search/indexes/ai-tech-daily-search/sources`;
